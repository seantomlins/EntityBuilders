...
public class EntityBuilderGenerator : ISourceGenerator
{
    ...
    private static void AddIdProviderSource(GeneratorExecutionContext context)
    {
        context.AnalyzerConfigOptions.GlobalOptions.TryGetValue("entity_builders.root_namespace", out var rootNamespace);
